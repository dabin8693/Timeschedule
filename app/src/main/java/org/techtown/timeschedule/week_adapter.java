...
public class week_adapter extends RecyclerView.Adapter<week_adapter.ViewHolder> {
    ...
    ArrayList<WeekList> items = new ArrayList<WeekList>();
    public void addItem(WeekList item) {
        items.add(item);
    }
    public void addpositionItem(WeekList item, int position){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        int width = parent.getMeasuredWidth()/frag_week.WEEK_CALENDER_SIZE;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        WeekList item = items.get(position);
        holder.setItem(item);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setItem(WeekList item){
